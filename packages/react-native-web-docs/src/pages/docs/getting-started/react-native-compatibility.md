...
:::lead
React Native for Web provides compatibility with the vast majority of React Native's JavaScript API. Features deprecated in React Native should be considered _unsupported_ in React Native for Web.
:::
